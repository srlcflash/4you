        ...
        <div class="card-panel">
            <div class="search-input-wrp grey lighten-3">
                <div class="search-input">
                    ...
                    <input id="searchText" name="searchAddText" class="input-search" type="text" placeholder="Search"
                           onkeyup="loadPendingAdsToPubData(1)">
                </div>
                <div class="search-action">

                    <button type="button" class="border-r-0 btn waves-effect waves-light btn-search deep-orange"
                            onclick="loadPendingAdsToPubData(1)">Search
                    </button>
                </div>
                <div class="search-action">
...
<script>
    ...
    function loadPendingAdsToPubData(page) {
        $.ajax({
            type: 'POST',
            url: "<?php echo Yii::app()->baseUrl . '/Admin/Advertisement/ViewPendingAdvertisementsToPublishData'; ?>",
