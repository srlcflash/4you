    ...
    <div class="card-content">
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Type</label>
                            <?php echo Chtml::dropDownList('ref_work_type_id', "", CHtml::listData(AdmWorkType::model()->findAll(), 'wt_id', 'wt_name'), array('class' => 'form-control', 'empty' => 'Select Type', 'options' => array($model->ref_work_type_id => array('selected' => true)))); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 uploader-container ">
                <div class="col-md-4">
                    <div class="file-field uploader form-group">
                        <div class="btn">
                            <span>Upload</span>
                            <?php
                            if ($adId == 0) {
                        ...
                        <div class="file-path-wrapper">
                            ...
                            if ($adId > 0) {
                                ...
                                $image = $model->ad_image_url != "" ? explode('/', $model->ad_image_url) : "";
                                $image = $model->ad_image_url == "" ? "" : $image[4];
                            } else {
...
<!--                    <label for="textarea1">Textarea</label>-->
                    <textarea id="textarea1" name="advertisementText"
                              class="form-control"><?php echo $model->ad_text; ?></textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    $('.uploaderOrEditor').on('change', function () {
        if ($(this).val() == 1) {
            $('.editor').slideUp('fast', function () {
                $('.uploader-container').slideDown('fast');
            });

        } else {
            $('.uploader-container').slideUp('fast', function () {
